        ...
        <div class="col-lg-4 col-sm-4 menu-top-right">
            <?php
                if(isset($_SESSION['UserId']))
                {
                    ...
                    <a style="display:inline-block" href="<?php echo ROOT_DIR ?>/php/account/myaccount.php"><div class="banner_utilisateur"><?php echo $_SESSION['UserPrenom']." ".$_SESSION['UserNom'] ?></div></a>
                    <?php
                }
                else
                {
